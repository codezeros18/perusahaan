...
export default function BoilerDetail() {
  ...
  const data = boilerId ? boilerData[boilerId] : null;
  const [zoomSrc, setZoomSrc] = useState<string | null>(null);

  if (!data) {
    return <p className="p-6">Boiler tidak ditemukan.</p>;
  }
          ...
          <div className="max-w-6xl mx-auto px-4 lg:px-6 py-6 font-dm">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
              ...
              <div className="bg-[#F8F8F8] px-8 py-6 text-gray-800 self-start order-3 md:order-3 lg:order-2">
                ...
                <button className="bg-orange-500 hover:bg-orange-600 text-[13px] leading-[19.5px] uppercase tracking-[0.52px] text-white py-2 px-6 cursor-pointer rounded transition duration-500 font-[500]">
                  {data.contactButton}
                </button>
              </div>
            </div>
